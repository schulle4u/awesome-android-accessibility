...
* Prudence Screen Reader - Alternativer Bildschirmleser, verspricht reaktionsschneller als TalkBack zu sein.  
  Download: [Google Play](https://play.google.com/store/apps/details?id=com.prudence.reader) oder [Entwickler-Website](https://www.audiblegame.com/prudence-screen-reader/)  
  Lizenz: Kostenlos.
* QR & Barcode Scanner  
...
* QR & Barcode-Scanner - datenschutzfreundlicher Scanner, entwickelt von der SECUSO-Forschungsgruppe an der TU Darmstadt.  
  Download: [F-Droid](https://f-droid.org/de/packages/com.secuso.privacyFriendlyCodeScanner/)  
  Lizenz: Kostenlos und Open Source.
...
* TGSpeechBox - Formant-Sprachausgabe, basierend auf NV Speech Player für NVDA.  
  Download: [Google Play](https://play.google.com/store/apps/details?id=com.tgspeechbox.tts) oder [GitHub, Beta-Releases wählen](https://github.com/tgeczy/TGSpeechBox/releases)  
  Lizenz: Kostenlos und Open Source.
...
* RadioDroid - Internet-Radio-Player mit Aufnahmefunktion, der die Datenbank von www.radio-browser.info verwendet.  
  Download: [F-Droid](https://f-droid.org/de/packages/net.programmierecke.radiodroid2/)  
  Lizenz: Kostenlos und Open Source.
...
* YAM Launcher - minimalistischer Textlauncher mit optionaler Wetteranzeige.  
  Download: [Google Play](https://play.google.com/store/apps/details?id=eu.ottop.yamlauncher), [F-Droid](https://f-droid.org/de/packages/eu.ottop.yamlauncher/) oder [Codeberg](https://codeberg.org/thomasboom/YAM-Launcher/releases/latest)  
  Lizenz: Kostenlos und Open Source.
...
* Aegis Authenticator - generiert 2FA-Schlüssel (Zwei-Faktor-Authentisierung)  
  ...
  Lizenz: Kostenlos und Open Source.
* Birday - Geburtstage und andere Ereignisse verwalten.  
  Download: [Google Play](https://play.google.com/store/apps/details?id=com.minar.birday) oder [F-Droid](https://f-droid.org/de/packages/com.minar.birday/)  
  Lizenz: Kostenlos und Open Source.
...
* GitHub - offizieller GitHub-Client  
  ...
  Lizenz: Kostenlos.
* HRLY - stündliches Zeitsignal bestehend aus Tonkombinationen.  
  Download: [F-Droid](https://f-droid.org/packages/com.ltrademark.hourly/) oder [GitHub](https://github.com/ltrademark/HRLY/releases/latest)  
  Lizenz: Kostenlos und Open Source.
